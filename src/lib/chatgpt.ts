...
4. 「最近〜」「実は〜」「ちょっと聞いてほしいんだけど」など自然な書き出しを使う
5. 具体的なエピソードは残すが、説明の仕方を変える（時系列を変える、詳細を追加するなど）
6. 感情表現を豊かにし、絵文字や「…」「！」なども適度に使う
7. 口語的で親しみやすい表現にする（「〜なんだよね」「〜って感じで」など）
8. 元の質問にない背景情報や心情を自然に追加する
...
【良い例（完全に書き直し）】
元: 「高3になった私。小6の時に出会ったある子とは、中学でも部活と塾が一緒で、ずっと仲良くしてた。」
良い修正: 「高校3年生です。小学校の頃から知ってる同級生がいて、中学時代も部活や塾で一緒だったから、すごく仲が良かったんです。でも、実はその子のことが好きだった私は、つい冷たい態度を取ってしまうこともあって…。塾や部活では普通にハグとかしてたのに、最近はドキドキしてしまいます。どうしたらいいんでしょうか。」
