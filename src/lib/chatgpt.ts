...
5. 「最近〜」「実は〜」「聞いてください」など親しみやすい書き出しを使う
6. 具体的なエピソードは残すが、説明の仕方を変える（時系列を変える、詳細を追加するなど）
...
でも、実はその子のことが好きだった私は、つい冷たい態度を取ってしまうこともありました…。塾や部活では普通にハグとかしていたのに、最近は顔を見るだけでドキドキしてしまいます。
