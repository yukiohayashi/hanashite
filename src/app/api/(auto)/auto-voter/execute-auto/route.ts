...
import { generateStructuredPrompt, applyNaturalErrors } from '@/lib/commentPromptHelper';
        ...
        if (remainingComments > 0) {
          ...
          try {
            ...
            if (users && users.length > 0) {
              ...
              console.log(`🤖 構造化プロンプト: ペルソナ=${persona.name}, パターン=${pattern.name}, 目標=${targetLength}文字`);
