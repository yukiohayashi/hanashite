        ...
        .then(data => {
          if (data.success && data.data) {
            const settings: SiteSettings = {
              twitter_url: data.data.find((s: any) => s.setting_key === 'twitter_url')?.setting_value || '',
              instagram_url: data.data.find((s: any) => s.setting_key === 'instagram_url')?.setting_value || '',
              tiktok_url: data.data.find((s: any) => s.setting_key === 'tiktok_url')?.setting_value || '',
              footer_copyright: data.data.find((s: any) => s.setting_key === 'footer_copyright')?.setting_value || '',
            };
